...
- Target dates: `209`
- Symbols: `3`
- Adjustment rows: `1306`
- Constraints triggered: `drawdown_circuit_breaker, max_single_weight, max_theme_weight`
...
- `2025-12-05` gross 0.000 -> 0.000; cash=1.000; constraints=drawdown_circuit_breaker;max_single_weight;max_theme_weight
