...
| cninfo_direct | True | True | announcement_metadata,direct_source_url,announce_date | announce_date_available | direct public endpoint can rate-limit or change schema; PDF body parsing is not yet implemented |
