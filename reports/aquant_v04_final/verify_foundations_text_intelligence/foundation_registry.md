...
| sentence_transformers | text_intelligence | candidate_optional | False | open_source_model_runtime | sentence-transformers |
| transformers_text_models | text_intelligence | candidate_optional | True | open_source_model_runtime | transformers |
| faiss | text_intelligence | candidate_optional | False | open_source | faiss-cpu |
| lancedb | text_intelligence | candidate_optional | False | open_source | lancedb |
