...
- `10d`: direction=`震荡偏弱`, prob_up=`0.397`, expected_return=`0.685%`, p10/p50/p90=`-7.346%/0.685%/9.918%`, trust=`data_insufficient`
...
- Base 情景第 10 日收盘：`33.8647`；p10/p50/p90 收盘带：`31.1635/33.8647/36.9703`。
