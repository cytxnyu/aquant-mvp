# Stock Trust Gate Report: 601899
...
- Block `local_signal_quality`: confidence=0.0307; sample_rank_ic=0.0000
...
- Block `local_signal_quality`: confidence=0.0200; sample_rank_ic=0.0000
...
- Block `local_signal_quality`: confidence=0.0026; sample_rank_ic=0.0000

### 60d - `model_failed`
- Block `walk_forward_evidence_present`: walk_forward_evidence_missing
- Block `walk_forward_trusted`: walk_forward_status=missing; reasons=walk_forward_evidence_missing
- Block `walk_forward_rows`: walk_forward_rows=0
- Block `probability_calibration`: calibration_status=calibration_failed; ece=0.2130; rows=23275; method=platt
- Block `probability_error`: sample_oos_brier=0.2677
- Block `local_signal_quality`: confidence=0.0781; sample_rank_ic=0.0000