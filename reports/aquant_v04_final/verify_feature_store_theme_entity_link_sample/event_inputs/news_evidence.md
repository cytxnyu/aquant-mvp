...
- `300308` 2025-12-30 00:00:00: impact=0.178, weighted=0.048, reliability=0.40, link=0.93, positive=2, negative=1, risk=1
...
- `300308` 2025-12-30 00:00:00 [sample_announcement] order_contract: link=explicit_symbol/1.00; text=not_available/0; 300308 发布经营进展公告，订单合同和产能信息需要继续跟踪。
...
- `300308` 2025-12-30 00:00:00 [sample_announcement] order_contract/positive impact=0.55, reliability=0.40: link=explicit_symbol/1.00 公告: 300308 发布经营进展公告，订单合同和产能信息需要继续跟踪。 text=not_available/0 (no_url)
- `300308` 2025-12-30 00:00:00 [sample_policy_news] industry_policy/neutral impact=0.10, reliability=0.40: link=theme_keyword/0.78 政策支持AI算力、半导体、先进封装、数据中心和光模块产业链。 text=not_available/0 (no_url)
...
- `300308` 2025-12-27 00:00:00 [sample_industry_news] commodity_shock/positive impact=0.20, reliability=0.40: link=explicit_symbol/1.00 行业: 有色金属与新能源产业链价格波动，对相关股票形成商品价格冲击。 text=not_available/0 (no_url)
...
- `300308` 2025-12-24 00:00:00 [sample_risk_news] public_opinion_risk/negative impact=-0.55, reliability=0.40: link=explicit_symbol/1.00 风险: 300308 出现舆情风险提示，需降低事件置信度。 text=not_available/0 (no_url)
