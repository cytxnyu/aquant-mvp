...
FOUNDATION_REGISTRY: tuple[FoundationCapability, ...] = (
    ...
    FoundationCapability(
        ...
        "text_intelligence",
        "Chinese news/event embedding runtime for bge-m3 style semantic retrieval",
        2,
        ("sentence_transformers",),
        "sentence-transformers",
        "open_source_model_runtime",
        "candidate_optional",
        "pip install sentence-transformers -i https://pypi.tuna.tsinghua.edu.cn/simple",
        "Optional evidence/retrieval base; model files must be locally available and cannot directly create trade signals.",
    ),
    FoundationCapability(
        "transformers_text_models",
        "text_intelligence",
        "FinBERT/Chinese RoBERTa/Qwen/DeepSeek runtime for event classification and summaries",
        2,
        ("transformers",),
        "transformers",
        "open_source_model_runtime",
        ...
        "Optional text model runtime; current trusted path remains rule-based until PIT-labeled walk-forward evidence proves value.",
    ),
    FoundationCapability(
        "faiss",
        "text_intelligence",
        ...
        "Optional vector store for evidence retrieval; not a trading signal by itself.",
    ),
    FoundationCapability(
        "lancedb",
        "text_intelligence",
        "persistent local vector database for event evidence",
        3,
        ("lancedb",),
        "lancedb",
        "open_source",
        ...
        "Optional persistent vector store for news/event evidence.",
    ),
    FoundationCapability(
        "ta_lib",
        "factor_engine",
